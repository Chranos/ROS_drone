...
echo_and_run cd "/home/yahboom/software/world_canvas/src/world_canvas_libs/world_canvas_utils"
...
echo_and_run /usr/bin/env \
    ...
    "/home/yahboom/software/world_canvas/src/world_canvas_libs/world_canvas_utils/setup.py" \
     \
    build --build-base "/home/yahboom/software/world_canvas/build/world_canvas_libs/world_canvas_utils" \
    install \
    --root="${DESTDIR-/}" \
