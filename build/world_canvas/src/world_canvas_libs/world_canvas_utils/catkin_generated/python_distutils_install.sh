...
echo_and_run cd "/home/chranos/ROS/ROS_drone/src/world_canvas/src/world_canvas_libs/world_canvas_utils"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/chranos/ROS/ROS_drone/src/world_canvas/src/world_canvas_libs/world_canvas_utils/setup.py" \
     \
    build --build-base "/home/chranos/ROS/ROS_drone/build/world_canvas/src/world_canvas_libs/world_canvas_utils" \
    install \
    --root="${DESTDIR-/}" \
