...
echo_and_run cd "/home/chranos/ROS/ROS_drone/src/world_canvas/src/world_canvas_libs/world_canvas_client_py"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/chranos/ROS/ROS_drone/src/world_canvas/src/world_canvas_libs/world_canvas_client_py/setup.py" \
     \
    build --build-base "/home/chranos/ROS/ROS_drone/build/world_canvas/src/world_canvas_libs/world_canvas_client_py" \
    install \
    --root="${DESTDIR-/}" \
