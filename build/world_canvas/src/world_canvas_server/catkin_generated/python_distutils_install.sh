...
echo_and_run cd "/home/chranos/ROS/ROS_drone/src/world_canvas/src/world_canvas_server"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/chranos/ROS/ROS_drone/src/world_canvas/src/world_canvas_server/setup.py" \
     \
    build --build-base "/home/chranos/ROS/ROS_drone/build/world_canvas/src/world_canvas_server" \
    install \
    --root="${DESTDIR-/}" \
