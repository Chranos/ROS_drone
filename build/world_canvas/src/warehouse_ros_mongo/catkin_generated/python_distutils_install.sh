...
echo_and_run cd "/home/chranos/ROS/ROS_drone/src/world_canvas/src/warehouse_ros_mongo"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/chranos/ROS/ROS_drone/src/world_canvas/src/warehouse_ros_mongo/setup.py" \
     \
    build --build-base "/home/chranos/ROS/ROS_drone/build/world_canvas/src/warehouse_ros_mongo" \
    install \
    --root="${DESTDIR-/}" \
